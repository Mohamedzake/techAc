...
const ContactUsGreen = () => {
  return (
    <section className="bg-gradient-to-br from-[#e8f5e9] to-[#f1fdf3] text-green-900 py-28 px-4">
      <div className="max-w-6xl mx-auto text-center mb-12">
        <h2 className="text-4xl font-bold text-green-700">دعونا نتواصل</h2>
        <p className="text-green-600 mt-4 max-w-2xl text-2xl mx-auto">
          .نحن هنا لمساعدتك — في كل ما يتعلق بالبرمجة، التعاون، أو التطوير
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col justify-center text-green-800 space-y-6">
          <div>
            ...
            <p className="mt-1 text-green-700">contact@fdfg.com</p>
          </div>
          <div>
            <h3 className="text-xl font-bold">الهاتف</h3>
            <p className="mt-1 text-green-700">+20 109 966 047</p>
          </div>
          <div>
            <h3 className="text-xl font-bold">المكتب</h3>
            <p className="mt-1 text-green-700">مدينة 6 أكتوبر، مصر</p>
          </div>
        </div>
      </div>
    </section>
